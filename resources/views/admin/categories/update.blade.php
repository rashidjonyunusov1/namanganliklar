            ...
            <div class="bg-light rounded h-100 p-4 form-control">
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="c_name_uz" value="{{ $category->c_name_uz }}" class="form-control" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Name ru</label>
                        <input type="text" name="c_name_ru" value="{{ $category->c_name_ru }}" class="form-control" aria-describedby="emailHelp">
                    </div>
